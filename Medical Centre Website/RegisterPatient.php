...
if(isset($_POST['submit'])){
    ...
    $query1= "INSERT INTO patients ( Firstname, Lastname, DOB, Gender, Address, PostCode, PhoneNumber, Email, Password)
...
<html>
    ...
    <body> 
        <h1 style="border:4px solid DodgerBlue;"> Register Patient </h1> 
        <div class="btn-group">
        ...
        <form action="RegisterPatient.php" method="POST" style="clear:both">
